package com.example.projektzaliczeniowyow.database;

import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.CLIENTS_COLUMN_EMAIL;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.CLIENTS_COLUMN_FULLNAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.CLIENTS_COLUMN_ID;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.CLIENTS_COLUMN_PASSWORD;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.CLIENTS_COLUMN_PHONE_NUMBER;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.CLIENTS_TABLE_NAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.COMPUTERS_COLUMN_ID;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.COMPUTERS_TABLE_NAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.ITEMS_COLUMN_NAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.ITEMS_COLUMN_PRICE;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.KEYBOARDS_COLUMN_ID;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.KEYBOARDS_TABLE_NAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.MICE_COLUMN_ID;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.MICE_TABLE_NAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.MONITORS_COLUMN_ID;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.MONITORS_TABLE_NAME;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.ORDERS_COLUMN_CLIENT_ID;
import static com.example.projektzaliczeniowyow.database.FeedReaderContract.FeedEntry.ORDERS_TABLE_NAME;
...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_INSERT_KEYBOARDS =
            "INSERT INTO " + KEYBOARDS_TABLE_NAME + " VALUES " +
                    "(0, 'T-WOLF T200', 'RGB Podświetlana klawiatura', 18.99), " +
    ...
    private static final String SQL_INSERT_MICE =
            "INSERT INTO " + MICE_TABLE_NAME + " VALUES " +
                    "(0, 'Defender Shepard GM-620L', 'Myszka przewodowa z sensorem optycznym', 10.99), " +
    ...
    private static final String SQL_INSERT_MONITORS =
            "INSERT INTO " + MONITORS_TABLE_NAME + " VALUES " +
                    "(0, 'Acer NITRO VG270UP', 'IPS WQHD 1ms 144Hz HDR', 269.99), " +
